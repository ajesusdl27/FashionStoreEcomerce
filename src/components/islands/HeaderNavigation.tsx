  ...
  return (
    <nav className="hidden lg:flex items-center gap-8">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {/* Dropdown Menu */}
        {isDropdownOpen && (
          <div className="absolute left-0 top-full mt-3 w-56 glass border border-border rounded-lg shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
            {isLoading ? (
