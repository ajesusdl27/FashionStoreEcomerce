import{$ as f,b,u,r as x}from"./cart.Bikz8RX5.js";const l=50,p=4.99;function c(t){return new Intl.NumberFormat("es-ES",{style:"currency",currency:"EUR"}).format(t)}function h(){const t=f.get(),r=b.get(),s=document.getElementById("cart-items"),i=document.getElementById("cart-empty");if(!(!s||!i)){if(t.length===0){s.classList.add("hidden"),i.classList.remove("hidden"),g(0);return}s.classList.remove("hidden"),i.classList.add("hidden"),s.innerHTML=t.map(e=>`
