...
import { manifest } from './manifest_CIwNFvv2.mjs';
...
const _page4 = () => import('./pages/admin/newsletter/new.astro.mjs');
const _page5 = () => import('./pages/admin/newsletter/send/_id_.astro.mjs');
const _page6 = () => import('./pages/admin/newsletter/subscribers.astro.mjs');
const _page7 = () => import('./pages/admin/newsletter.astro.mjs');
const _page8 = () => import('./pages/admin/pedidos/_id_.astro.mjs');
const _page9 = () => import('./pages/admin/pedidos.astro.mjs');
const _page10 = () => import('./pages/admin/productos/nuevo.astro.mjs');
const _page11 = () => import('./pages/admin/productos/_id_.astro.mjs');
const _page12 = () => import('./pages/admin/productos.astro.mjs');
const _page13 = () => import('./pages/admin.astro.mjs');
const _page14 = () => import('./pages/api/admin/categorias.astro.mjs');
const _page15 = () => import('./pages/api/admin/configuracion.astro.mjs');
const _page16 = () => import('./pages/api/admin/newsletter/campaigns.astro.mjs');
const _page17 = () => import('./pages/api/admin/newsletter/mark-sent.astro.mjs');
const _page18 = () => import('./pages/api/admin/newsletter/send-chunk.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/admin/newsletter/new.astro", _page4],
    ["src/pages/admin/newsletter/send/[id].astro", _page5],
    ["src/pages/admin/newsletter/subscribers.astro", _page6],
    ["src/pages/admin/newsletter/index.astro", _page7],
    ["src/pages/admin/pedidos/[id].astro", _page8],
    ["src/pages/admin/pedidos/index.astro", _page9],
    ["src/pages/admin/productos/nuevo.astro", _page10],
    ["src/pages/admin/productos/[id].astro", _page11],
    ["src/pages/admin/productos/index.astro", _page12],
    ["src/pages/admin/index.astro", _page13],
    ["src/pages/api/admin/categorias.ts", _page14],
    ["src/pages/api/admin/configuracion.ts", _page15],
    ["src/pages/api/admin/newsletter/campaigns.ts", _page16],
    ["src/pages/api/admin/newsletter/mark-sent.ts", _page17],
    ["src/pages/api/admin/newsletter/send-chunk.ts", _page18],
